...
//$this_title = 'Swear Box | Eclectic App Development';

$this_title = "Swear Cards";

//$swear_file = json_decode(file_get_contents('../data/swears.js') );
//$swears_l = $swear_file[5];
//$swears_r = $swear_file["swears"][1];

//$swear_l = $swears_l[random_int(0, count($swears_l) - 1 )];
//$swear_r = $swears_r[random_int(0,  count($swears_r) - 1)];

//$this_title .= $swear_l . ' ' . $swear_r;

$this_desc = "Make your own using the Swear Cards";
